...
},{"./gsap-core.js":"../node_modules/gsap/gsap-core.js","./CSSPlugin.js":"../node_modules/gsap/CSSPlugin.js"}],"../node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"../node_modules/easing-js/easing.js":[function(require,module,exports) {
"use strict";
...
var _easingJs = _interopRequireDefault(require("easing-js"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

//initialize scrollbar package
var verticalScrollbar = _smoothScrollbar.default.init(document.querySelector('.scrollbar'), {
  dumping: 0.1,
  delegateTo: document
});
...
verticalScrollbar.track.xAxis.element.remove(); //scrollevent

verticalScrollbar.addListener(function (s) {
...
function scrollAchievement() {
  verticalScrollbar.scrollTo(0, 300, 700); // verticalScrollbar.scrollTo(0, 100, 600, {
  //   callback: () => {},
  //   easing: easing.easeOutBack,
  // });
}

var scrollbtn = document.querySelector('.look-btn');
scrollbtn.addEventListener('click', scrollAchievement); //menubtn script
//CURSOR ANIMATION

var cursor = document.createElement('div');
cursor.className = 'cursor';
var cursorF = document.createElement('div');
...
var highlightZone = document.querySelector('.text-area');
highlightZone.addEventListener('mouseenter', function (e) {
  // console.log(e.clientX); 
  // console.log(e.clientX);
  _gsap.gsap.to(cursor, {
    scale: 10.5
  });

  _gsap.gsap.to(cursorF, {
    scale: .2
  });
});
highlightZone.addEventListener('mouseleave', function (e) {
  _gsap.gsap.to(cursor, {
    scale: 1
  });
...
},{"smooth-scrollbar":"../node_modules/smooth-scrollbar/index.js","gsap":"../node_modules/gsap/index.js","../src/styles/main.scss":"styles/main.scss","easing-js":"../node_modules/easing-js/easing.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
